...
public final class a extends c {
    ...
    public List<Certificate> e(List<? extends Certificate> chain, String hostname) {
        ...
        for (int i10 = 0; i10 < 9; i10++) {
            ...
            X509Certificate a10 = this.f358a.a(x509Certificate);
            if (a10 == null) {
                ...
                while (it.hasNext()) {
                    ...
                    if (s(x509Certificate, x509Certificate2)) {
                        it.remove();
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof a) && Intrinsics.areEqual(((a) obj).f358a, this.f358a);
    }
    ...
    public final boolean s(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
