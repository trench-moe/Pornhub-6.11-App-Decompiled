...
public final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo1316elapsedNowUwyO8pc() {
        return Duration.m1358minusLRDsOJo(this.mark.mo1316elapsedNowUwyO8pc(), m1318getAdjustmentUwyO8pc());
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1318getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo1317plusLRDsOJo(long j10) {
        return new AdjustedTimeMark(this.mark, Duration.m1359plusLRDsOJo(m1318getAdjustmentUwyO8pc(), j10), null);
    }
}
