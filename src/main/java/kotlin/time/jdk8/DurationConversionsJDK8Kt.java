...
public final class DurationConversionsJDK8Kt {
    ...
    private static final Duration m1457toJavaDurationLRDsOJo(long j10) {
        Duration ofSeconds = Duration.ofSeconds(kotlin.time.Duration.m1344getInWholeSecondsimpl(j10), kotlin.time.Duration.m1346getNanosecondsComponentimpl(j10));
