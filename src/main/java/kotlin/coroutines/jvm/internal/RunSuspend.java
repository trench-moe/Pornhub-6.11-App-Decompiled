...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> m1203getResultxLWZpok = m1203getResultxLWZpok();
                if (m1203getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(m1203getResultxLWZpok.m25unboximpl());
                }
            }
        }
    }
    ...
    public final Result<Unit> m1203getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            setResult(Result.m15boximpl(obj));
            notifyAll();
