...
public final class ReflectionTypes {
    ...
    public final ClassDescriptor find(String str, int i10) {
        ...
        ClassifierDescriptor mo1280getContributedClassifier = getKotlinReflectScope().mo1280getContributedClassifier(identifier, NoLookupLocation.FROM_REFLECTION);
        ClassDescriptor classDescriptor = mo1280getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) mo1280getContributedClassifier : null;
        return classDescriptor == null ? this.notFoundClasses.getClass(new ClassId(StandardNames.KOTLIN_REFLECT_FQ_NAME, identifier), CollectionsKt.listOf(Integer.valueOf(i10))) : classDescriptor;
    }
