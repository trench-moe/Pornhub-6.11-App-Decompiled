...
public final class LazyJavaPackageFragmentProvider implements PackageFragmentProviderOptimized {
    ...
    private final LazyJavaResolverContext f12086c;
    ...
    public LazyJavaPackageFragmentProvider(JavaResolverComponents components) {
        ...
        this.f12086c = lazyJavaResolverContext;
    ...
    private final LazyJavaPackageFragment getPackageFragment(FqName fqName) {
        final JavaPackage findPackage = this.f12086c.getComponents().getFinder().findPackage(fqName);
        if (findPackage == null) {
            return null;
        }
        return this.packageFragments.computeIfAbsent(fqName, new Function0<LazyJavaPackageFragment>() { // from class: kotlin.reflect.jvm.internal.impl.load.java.lazy.LazyJavaPackageFragmentProvider$getPackageFragment$1
            ...
            public final LazyJavaPackageFragment invoke() {
                ...
                lazyJavaResolverContext = LazyJavaPackageFragmentProvider.this.f12086c;
    ...
    public boolean isEmpty(FqName fqName) {
        Intrinsics.checkNotNullParameter(fqName, "fqName");
        return this.f12086c.getComponents().getFinder().findPackage(fqName) == null;
    }

    public String toString() {
        return Intrinsics.stringPlus("LazyJavaPackageFragmentProvider of module ", this.f12086c.getComponents().getModule());
    }
}
