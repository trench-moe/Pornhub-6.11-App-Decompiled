...
public final class FieldSet<FieldDescriptorType extends FieldDescriptorLite<FieldDescriptorType>> {
        ...
        if (fieldDescriptorLite.isRepeated()) {
            ...
            if (!fieldDescriptorLite.isPacked()) {
                for (Object obj2 : (List) obj) {
                    i10 += computeElementSize(liteType, number, obj2);
                }
                return i10;
            }
            for (Object obj3 : (List) obj) {
                i10 += computeElementSizeNoTag(liteType, obj3);
            }
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, WireFormat.FieldType fieldType, boolean z10) {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            ...
            case 9:
                return z10 ? codedInputStream.readStringRequireUtf8() : codedInputStream.readString();
            case 10:
    ...
    */
    ...
    private static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i10, Object obj) {
        if (fieldType == WireFormat.FieldType.GROUP) {
