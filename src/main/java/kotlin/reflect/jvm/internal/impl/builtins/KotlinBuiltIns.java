...
public abstract class KotlinBuiltIns {
    ...
    public KotlinBuiltIns(StorageManager storageManager) {
        ...
        this.builtInClassesByName = storageManager.createMemoizedFunction(new Function1<Name, ClassDescriptor>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.3
            ...
            public ClassDescriptor invoke(Name name) {
                ClassifierDescriptor mo1280getContributedClassifier = KotlinBuiltIns.this.getBuiltInsPackageScope().mo1280getContributedClassifier(name, NoLookupLocation.FROM_BUILTINS);
                if (mo1280getContributedClassifier == null) {
                    StringBuilder m10 = a.m("Built-in class ");
                    m10.append(StandardNames.BUILT_INS_PACKAGE_FQ_NAME.child(name));
                    m10.append(" is not found");
                    throw new AssertionError(m10.toString());
                } else if (mo1280getContributedClassifier instanceof ClassDescriptor) {
                    return (ClassDescriptor) mo1280getContributedClassifier;
                } else {
                    throw new AssertionError("Must be a class descriptor " + name + ", but was " + mo1280getContributedClassifier);
                }
            }
        });
    }
    ...
    private static KotlinType getElementTypeForUnsignedArray(KotlinType kotlinType, ModuleDescriptor moduleDescriptor) {
        ...
        if (!unsignedTypes.isShortNameOfUnsignedArray(mo1278getDeclarationDescriptor.getName()) || (classId = DescriptorUtilsKt.getClassId(mo1278getDeclarationDescriptor)) == null || (unsignedClassIdByArrayClassId = unsignedTypes.getUnsignedClassIdByArrayClassId(classId)) == null || (findClassAcrossModuleDependencies = FindClassInModuleKt.findClassAcrossModuleDependencies(moduleDescriptor, unsignedClassIdByArrayClassId)) == null) {
            return null;
        }
    ...
    public static PrimitiveType getPrimitiveArrayElementType(KotlinType kotlinType) {
        ...
        return getPrimitiveArrayType(mo1278getDeclarationDescriptor);
    }
    ...
    public static boolean isPrimitiveArray(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1278getDeclarationDescriptor = kotlinType.getConstructor().mo1278getDeclarationDescriptor();
        return (mo1278getDeclarationDescriptor == null || getPrimitiveArrayType(mo1278getDeclarationDescriptor) == null) ? false : true;
    }
    ...
    public static boolean isPrimitiveTypeOrNullablePrimitiveType(KotlinType kotlinType) {
        ...
        ClassifierDescriptor mo1278getDeclarationDescriptor = kotlinType.getConstructor().mo1278getDeclarationDescriptor();
        return (mo1278getDeclarationDescriptor instanceof ClassDescriptor) && isPrimitiveClass((ClassDescriptor) mo1278getDeclarationDescriptor);
    }
    ...
    public static boolean isTypeConstructorForGivenClass(TypeConstructor typeConstructor, FqNameUnsafe fqNameUnsafe) {
        ...
        return (mo1278getDeclarationDescriptor instanceof ClassDescriptor) && classFqNameEquals(mo1278getDeclarationDescriptor, fqNameUnsafe);
    }
    ...
    public void setBuiltInsModule(final ModuleDescriptorImpl moduleDescriptorImpl) {
        ...
        this.storageManager.compute(new Function0<Void>() { // from class: kotlin.reflect.jvm.internal.impl.builtins.KotlinBuiltIns.4
            ...
            public Void invoke() {
                ...
                StringBuilder m10 = a.m("Built-ins module is already set: ");
                m10.append(KotlinBuiltIns.this.builtInsModule);
                m10.append(" (attempting to reset to ");
                m10.append(moduleDescriptorImpl);
                m10.append(")");
                throw new AssertionError(m10.toString());
            }
        });
