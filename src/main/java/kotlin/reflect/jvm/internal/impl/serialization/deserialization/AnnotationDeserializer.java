...
public final class AnnotationDeserializer {
    ...
    private final ConstantValue<?> resolveValueAndCheckExpectedType(KotlinType kotlinType, ProtoBuf.Annotation.Argument.Value value, NameResolver nameResolver) {
        ...
        if (resolveValue == null) {
            ...
            StringBuilder m10 = a.m("Unexpected argument value: actual type ");
            m10.append(value.getType());
            m10.append(" != expected type ");
            m10.append(kotlinType);
            return companion.create(m10.toString());
        }
        return resolveValue;
    }
    ...
    public final ConstantValue<?> resolveValue(KotlinType expectedType, ProtoBuf.Annotation.Argument.Value value, NameResolver nameResolver) {
        ...
        switch (type == null ? -1 : WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
            ...
            default:
                StringBuilder m10 = a.m("Unsupported annotation argument type: ");
                m10.append(value.getType());
                m10.append(" (expected ");
                m10.append(expectedType);
                m10.append(')');
