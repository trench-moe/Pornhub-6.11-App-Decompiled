...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    */
    ...
    public KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo1278getDeclarationDescriptor())) {
            return null;
        }
    ...
    public Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z10) {
        DeclarationDescriptor containingDeclaration = mo1278getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor mo1270getCompanionObjectDescriptor = classDescriptor.mo1270getCompanionObjectDescriptor();
        if (z10 && mo1270getCompanionObjectDescriptor != null) {
            smartList.add(mo1270getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo1278getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo1278getDeclarationDescriptor();
    ...
    public boolean isSameClassifier(ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo1278getDeclarationDescriptor(), classifierDescriptor);
    }
}
