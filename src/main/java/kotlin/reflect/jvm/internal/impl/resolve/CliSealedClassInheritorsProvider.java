        ...
        for (DeclarationDescriptor declarationDescriptor : ResolutionScope.DefaultImpls.getContributedDescriptors$default(memberScope, DescriptorKindFilter.CLASSIFIERS, null, 2, null)) {
            if (declarationDescriptor instanceof ClassDescriptor) {
                ...
                if (classDescriptor2.isExpect()) {
                    ...
                    ClassifierDescriptor mo1280getContributedClassifier = memberScope.mo1280getContributedClassifier(name, NoLookupLocation.WHEN_GET_ALL_DESCRIPTORS);
                    classDescriptor2 = mo1280getContributedClassifier instanceof ClassDescriptor ? (ClassDescriptor) mo1280getContributedClassifier : mo1280getContributedClassifier instanceof TypeAliasDescriptor ? ((TypeAliasDescriptor) mo1280getContributedClassifier).getClassDescriptor() : null;
                }
