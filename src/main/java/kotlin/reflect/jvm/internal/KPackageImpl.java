...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    public PropertyDescriptor getLocalProperty(int i10) {
        ...
        ProtoBuf.Property property = (ProtoBuf.Property) ProtoBufUtilKt.getExtensionOrNull(component2, packageLocalVariable, i10);
        if (property == null) {
            return null;
        }
