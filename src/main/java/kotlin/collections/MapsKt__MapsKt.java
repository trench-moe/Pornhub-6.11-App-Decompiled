...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    public static final <K, V> V getOrElseNullable(Map<K, ? extends V> map, K k10, Function0<? extends V> defaultValue) {
        ...
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v2 = map.get(k10);
        return (v2 != null || map.containsKey(k10)) ? v2 : defaultValue.invoke();
    }
    ...
    @InlineOnly
    private static final <K, V> void set(Map<K, V> map, K k10, V v2) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        map.put(k10, v2);
    }
