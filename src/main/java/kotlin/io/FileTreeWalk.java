...
public final class FileTreeWalk implements Sequence<File> {
    ...
    public final class FileTreeWalkIterator extends AbstractIterator<File> {
        ...
        private final DirectoryState directoryState(File file) {
            int i10 = WhenMappings.$EnumSwitchMapping$0[this.this$0.direction.ordinal()];
            if (i10 != 1) {
                if (i10 == 2) {
    ...
    public /* synthetic */ FileTreeWalk(File file, FileWalkDirection fileWalkDirection, Function1 function1, Function1 function12, Function2 function2, int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(file, (i11 & 2) != 0 ? FileWalkDirection.TOP_DOWN : fileWalkDirection, function1, function12, function2, (i11 & 32) != 0 ? IntCompanionObject.MAX_VALUE : i10);
    }
    ...
    public final FileTreeWalk maxDepth(int i10) {
        if (i10 > 0) {
            return new FileTreeWalk(this.start, this.direction, this.onEnter, this.onLeave, this.onFail, i10);
        }
