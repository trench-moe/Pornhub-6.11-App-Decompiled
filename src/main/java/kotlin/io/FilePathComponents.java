...
public final class FilePathComponents {
    ...
    public final File subPath(int i10, int i11) {
        ...
        List<File> subList = this.segments.subList(i10, i11);
    ...
    public String toString() {
        StringBuilder m10 = a.m("FilePathComponents(root=");
        m10.append(this.root);
        m10.append(", segments=");
        return android.support.v4.media.a.k(m10, this.segments, ')');
    }
}
