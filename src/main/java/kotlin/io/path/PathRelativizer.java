    ...
    public final Path tryRelativeTo(Path path, Path base) {
        ...
        while (i10 < min) {
            ...
            if (!Intrinsics.areEqual(name, path2)) {
                break;
            } else if (!Intrinsics.areEqual(r10.getName(i10), path2)) {
        ...
        if (Intrinsics.areEqual(r10, normalize) || !Intrinsics.areEqual(normalize, emptyPath)) {
            ...
            r10 = StringsKt.endsWith$default(obj, separator, false, 2, (Object) null) ? relativize.getFileSystem().getPath(StringsKt.dropLast(obj, relativize.getFileSystem().getSeparator().length()), new String[0]) : relativize;
        }
