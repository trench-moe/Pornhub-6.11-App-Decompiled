...
class PathsKt__PathUtilsKt extends PathsKt__PathReadWriteKt {
    ...
    public static final String getExtension(Path path) {
        ...
        return fileName == null ? BuildConfig.FLAVOR : StringsKt.substringAfterLast(fileName.toString(), '.', BuildConfig.FLAVOR);
    }
    ...
    public static final String getNameWithoutExtension(Path path) {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Path fileName = path.getFileName();
        return fileName == null ? BuildConfig.FLAVOR : StringsKt.substringBeforeLast$default(fileName.toString(), ".", (String) null, 2, (Object) null);
    }
