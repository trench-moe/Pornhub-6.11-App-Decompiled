...
public final class SequenceBuilderIterator<T> extends SequenceScope<T> implements Iterator<T>, Continuation<Unit>, KMappedMarker {
    ...
    private final Throwable exceptionalState() {
        int i10 = this.state;
        return i10 != 4 ? i10 != 5 ? new IllegalStateException(Intrinsics.stringPlus("Unexpected state of the iterator: ", Integer.valueOf(this.state))) : new IllegalStateException("Iterator has failed.") : new NoSuchElementException();
    }
