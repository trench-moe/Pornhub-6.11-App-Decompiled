...
public final class ReplaySubject<T> extends Subject<T> {
    ...
    public static <T> ReplaySubject<T> createUnbounded() {
        return new ReplaySubject<>(new SizeBoundReplayBuffer(IntCompanionObject.MAX_VALUE));
    }
    ...
    public static <T> ReplaySubject<T> createWithTime(long j10, TimeUnit timeUnit, Scheduler scheduler) {
        return new ReplaySubject<>(new SizeAndTimeBoundReplayBuffer(IntCompanionObject.MAX_VALUE, j10, timeUnit, scheduler));
    }
