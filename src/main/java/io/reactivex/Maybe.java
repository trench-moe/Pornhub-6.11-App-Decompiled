...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> concat(b<? extends MaybeSource<? extends T>> bVar, int i10) {
    ...
    public static <T> Flowable<T> merge(b<? extends MaybeSource<? extends T>> bVar) {
        return merge(bVar, (int) IntCompanionObject.MAX_VALUE);
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> merge(b<? extends MaybeSource<? extends T>> bVar, int i10) {
    ...
    public static <T> Flowable<T> mergeDelayError(b<? extends MaybeSource<? extends T>> bVar) {
        return mergeDelayError(bVar, (int) IntCompanionObject.MAX_VALUE);
    }
    ...
    @CheckReturnValue
    @NonNull
    public static <T> Flowable<T> mergeDelayError(b<? extends MaybeSource<? extends T>> bVar, int i10) {
        ObjectHelper.requireNonNull(bVar, "source is null");
        ObjectHelper.verifyPositive(i10, "maxConcurrency");
