...
public final class FlowableCollect<T, U> extends AbstractFlowableWithUpstream<T, U> {
    ...
    public static final class CollectSubscriber<T, U> extends DeferredScalarSubscription<U> implements FlowableSubscriber<T> {
        ...
        public final U f10733u;
        public d upstream;

        public CollectSubscriber(c<? super U> cVar, U u2, BiConsumer<? super U, ? super T> biConsumer) {
            super(cVar);
        ...
        public void onNext(T t2) {
            ...
            try {
                this.collector.accept((U) this.f10733u, t2);
            } catch (Throwable th) {
