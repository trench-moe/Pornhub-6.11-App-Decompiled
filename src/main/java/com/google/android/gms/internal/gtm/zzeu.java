...
public final class zzeu {
    ...
    static {
        ...
        Integer valueOf2 = Integer.valueOf((int) FullscreenMode.NAVIGATION_BAR_TIMEOUT_MS);
        ...
        Integer valueOf3 = Integer.valueOf((int) ConstantsKt.DEFAULT_BUFFER_SIZE);
        ...
        zzH = zzet.zza(BuildConfig.FLAVOR, BuildConfig.FLAVOR, new zzes() { // from class: com.google.android.gms.internal.gtm.zzdt
        });
