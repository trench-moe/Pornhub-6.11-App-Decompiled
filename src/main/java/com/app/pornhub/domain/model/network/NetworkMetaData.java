...
public final class NetworkMetaData {
    ...
    public NetworkMetaData(String id2, String username, String thumbnail, boolean z10, String videoViewsCount, int i10, String subscribersCount) {
    ...
    public static /* synthetic */ NetworkMetaData copy$default(NetworkMetaData networkMetaData, String str, String str2, String str3, boolean z10, String str4, int i10, String str5, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            str = networkMetaData.f4902id;
        }
        if ((i11 & 2) != 0) {
            str2 = networkMetaData.username;
        }
        String str6 = str2;
        if ((i11 & 4) != 0) {
            str3 = networkMetaData.thumbnail;
        }
        String str7 = str3;
        if ((i11 & 8) != 0) {
            z10 = networkMetaData.isVerified;
        }
        boolean z11 = z10;
        if ((i11 & 16) != 0) {
            str4 = networkMetaData.videoViewsCount;
        }
        String str8 = str4;
        if ((i11 & 32) != 0) {
            i10 = networkMetaData.videosCount;
        }
        int i12 = i10;
        if ((i11 & 64) != 0) {
            str5 = networkMetaData.subscribersCount;
        }
        return networkMetaData.copy(str, str6, str7, z11, str8, i12, str5);
    }
    ...
    public final NetworkMetaData copy(String id2, String username, String thumbnail, boolean z10, String videoViewsCount, int i10, String subscribersCount) {
        Intrinsics.checkNotNullParameter(id2, "id");
        Intrinsics.checkNotNullParameter(username, "username");
        Intrinsics.checkNotNullParameter(thumbnail, "thumbnail");
        Intrinsics.checkNotNullParameter(videoViewsCount, "videoViewsCount");
        Intrinsics.checkNotNullParameter(subscribersCount, "subscribersCount");
        return new NetworkMetaData(id2, username, thumbnail, z10, videoViewsCount, i10, subscribersCount);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof NetworkMetaData) {
            ...
            return Intrinsics.areEqual(this.f4902id, networkMetaData.f4902id) && Intrinsics.areEqual(this.username, networkMetaData.username) && Intrinsics.areEqual(this.thumbnail, networkMetaData.thumbnail) && this.isVerified == networkMetaData.isVerified && Intrinsics.areEqual(this.videoViewsCount, networkMetaData.videoViewsCount) && this.videosCount == networkMetaData.videosCount && Intrinsics.areEqual(this.subscribersCount, networkMetaData.subscribersCount);
        }
        return false;
    }
    ...
    public int hashCode() {
        int b10 = a.b(this.thumbnail, a.b(this.username, this.f4902id.hashCode() * 31, 31), 31);
    ...
    public String toString() {
        StringBuilder m10 = a.m("NetworkMetaData(id=");
        m10.append(this.f4902id);
        m10.append(", username=");
